...
export function LessonPage() {
  ...
  const completed = progress.completedLessonIds.includes(lesson.id); const previous = lessons[lessonIndex - 1] ?? null; const next = lessons[lessonIndex + 1] ?? null
